...
class BankAccountDetailsApiController extends Controller
{
    public function index()
    {
        ...
        return new BankAccountDetailResource(BankAccountDetail::with(['account_type', 'currency'])->get());
    }
    ...
    public function show(BankAccountDetail $bankAccountDetail)
    {
        ...
        return new BankAccountDetailResource($bankAccountDetail->load(['account_type', 'currency']));
    }
