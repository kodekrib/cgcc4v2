...
<body>
        ...
        <div class="sidebar-header bg-transparent p-0">
            <ul class="nav nav-underline nav-underline-primary" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#timeline" role="tab">
                        <svg class="icon" style="color: #999">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="timeline" role="tabpanel">
                <div class="list-group list-group-flush">
                    <div class="list-group-item border-start-4 border-start-secondary bg-light text-center fw-bold text-medium-emphasis text-uppercase small dark:bg-white dark:bg-opacity-10 dark:text-medium-emphasis">
                    ...
                    <div class="list-group-item border-start-4 border-start-warning list-group-item-divider">
                        <div class="avatar avatar-lg float-end"><img class="avatar-img"
                                src="coreui/assets/img/avatars/8.jpg" alt="user@email.com"></div>
                        <div>Meeting with <strong>HODs</strong></div><small class="text-medium-emphasis me-3">
                            <svg class="icon">
                    ...
                    <div class="list-group-item border-start-4 border-start-info">
                        <div class="avatar avatar-lg float-end"><img class="avatar-img"
                                src="coreui/assets/img/avatars/8.jpg" alt="user@email.com"></div>
                        <div>Skype with <strong>Technology Group</strong></div><small class="text-medium-emphasis me-3">
                            <svg class="icon">
                                <use xlink:href="coreui/vendors/@coreui/icons/svg/free.svg#cil-calendar"></use>
                    ...
                    <div class="clearfix mt-4">
                        <div class="form-check form-switch form-switch-lg">
                            <input class="form-check-input me-0" id="flexSwitchCheckDefaultLg" type="checkbox"
                                checked="">
                            <label class="form-check-label fw-semibold small" for="flexSwitchCheckDefaultLg">Meeting Notification</label>
                        </div>
                    </div>
                    <div><small class="text-medium-emphasis">This turn off meeting notification</small></div>
                </div>
                <div class="aside-options">
                    <div class="clearfix mt-3">
                        <div class="form-check form-switch form-switch-lg">
                            <input class="form-check-input me-0" id="flexSwitchCheckDefaultLg" type="checkbox" checked="">
                            <label class="form-check-label fw-semibold small" for="flexSwitchCheckDefaultLg">Chat Notification</label>
                        </div>
                    </div>
                    <div><small class="text-medium-emphasis">This turn off chat notification</small></div>
                </div>
                <div class="aside-options">
                    <div class="clearfix mt-3">
                        <div class="form-check form-switch form-switch-lg">
                            <input class="form-check-input me-0" id="flexSwitchCheckDefaultLg" type="checkbox" checked="">
                            <label class="form-check-label fw-semibold small" for="flexSwitchCheckDefaultLg">Messaging Notification</label>
                        </div>
                    </div>
                  <div><small class="text-medium-emphasis">This turn off message notification</small></div>
                </div>
                <hr>
            </div>
        </div>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light bg-opacity-50 dark:bg-transparent">
        ...
        <footer class="footer" style="margin: 20px;">
            <div><a href="https://thecitadelglobal.org" target="_blank" style="text-decoration: none; color:#333">The Citadel Community Global Church </a></div>
            <div class="ms-auto">Powered by&nbsp;Technology Group Of CGCC © 2023.</div>
        </footer>
