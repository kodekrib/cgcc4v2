...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-employmentStatusMembers">
                <thead>
                    <tr>
                        <th width="10">
...
<script>
  ...
  let table = $('.datatable-employmentStatusMembers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
