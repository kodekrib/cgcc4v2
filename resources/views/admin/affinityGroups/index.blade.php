...
@can('affinity_group_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'AffinityGroup', 'route' => 'admin.affinity-groups.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-AffinityGroup">
                <thead>
                    <tr>
                        <th width="10">
...
<script>
  ...
  let table = $('.datatable-AffinityGroup:not(.ajaxTable)').DataTable({ buttons: dtButtons })
