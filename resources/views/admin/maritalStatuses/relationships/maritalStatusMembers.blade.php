...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-maritalStatusMembers">
                <thead>
                    <tr>
                        <th width="10">
...
<script>
  ...
  let table = $('.datatable-maritalStatusMembers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
