...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.firstTimer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.first-timers.update", [$firstTimer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="service">{{ trans('cruds.firstTimer.fields.service') }}</label>
                <input class="form-control date {{ $errors->has('service') ? 'is-invalid' : '' }}" type="text" name="service" id="service" value="{{ old('service', $firstTimer->service) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $firstTimer->surname) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $firstTimer->first_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('middle_name') ? 'is-invalid' : '' }}" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $firstTimer->middle_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $firstTimer->date_of_birth) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marital_status') ? 'is-invalid' : '' }}" name="marital_status_id" id="marital_status_id">
                    @foreach($marital_statuses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('marital_status_id') ? old('marital_status_id') : $firstTimer->marital_status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('occupation') ? 'is-invalid' : '' }}" type="text" name="occupation" id="occupation" value="{{ old('occupation', $firstTimer->occupation) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                    ...
                    @foreach(App\Models\FirstTimer::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $firstTimer->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="age">{{ trans('cruds.firstTimer.fields.age') }}</label>
                <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" type="number" name="age" id="age" value="{{ old('age', $firstTimer->age) }}" step="1">
                @if($errors->has('age'))
                    <div class="invalid-feedback">
                        {{ $errors->first('age') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.firstTimer.fields.age_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="phone_number">{{ trans('cruds.firstTimer.fields.phone_number') }}</label>
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $firstTimer->phone_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $firstTimer->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('residential_address') ? 'is-invalid' : '' }}" name="residential_address" id="residential_address">{{ old('residential_address', $firstTimer->residential_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nearest_bus_stop') ? 'is-invalid' : '' }}" type="text" name="nearest_bus_stop" id="nearest_bus_stop" value="{{ old('nearest_bus_stop', $firstTimer->nearest_bus_stop) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country" id="country">
                    ...
                    @foreach(App\Models\FirstTimer::COUNTRY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('country', $firstTimer->country) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" name="state" id="state">
                    ...
                    @foreach(App\Models\FirstTimer::STATE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('state', $firstTimer->state) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('state'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city" id="city">
                    ...
                    @foreach(App\Models\FirstTimer::CITY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('city', $firstTimer->city) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('join_cgcc') ? 'is-invalid' : '' }}" name="join_cgcc" id="join_cgcc">
                    ...
                    @foreach(App\Models\FirstTimer::JOIN_CGCC_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('join_cgcc', $firstTimer->join_cgcc) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('start_ats') ? 'is-invalid' : '' }}" name="start_ats" id="start_ats">
                    ...
                    @foreach(App\Models\FirstTimer::START_ATS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('start_ats', $firstTimer->start_ats) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ats_mode') ? 'is-invalid' : '' }}" name="ats_mode" id="ats_mode">
                    ...
                    @foreach(App\Models\FirstTimer::ATS_MODE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ats_mode', $firstTimer->ats_mode) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('prayer_request') ? 'is-invalid' : '' }}" name="prayer_request" id="prayer_request">{{ old('prayer_request', $firstTimer->prayer_request) }}</textarea>
