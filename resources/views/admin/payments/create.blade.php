    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.payment.fields.payment_type') }}</label>
            ...
            <div class="form-group">
                <label for="surname">{{ trans('cruds.payment.fields.surname') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.payment.fields.surname_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="first_name">{{ trans('cruds.payment.fields.first_name') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.payment.fields.first_name_helper') }}</span>
            </div>
            <div class="form-group">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.payments.storeCKEditorImages') }}', true);
