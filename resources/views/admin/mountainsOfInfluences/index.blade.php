...
@can('mountains_of_influence_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'MountainsOfInfluence', 'route' => 'admin.mountains-of-influences.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-MountainsOfInfluence">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-MountainsOfInfluence:not(.ajaxTable)').DataTable({ buttons: dtButtons })
