...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-venueBookings">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($bookings as $key => $booking)
                        <tr data-entry-id="{{ $booking->id }}">
                            ...
                            <td>
                                {{ $booking->event->expected_amount ?? '' }}
                            </td>
                            <td>
                                {{ $booking->event->no_of_days ?? '' }}
                            </td>
                            <td>
                                {{ $booking->event->accredited ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-venueBookings:not(.ajaxTable)').DataTable({ buttons: dtButtons })
