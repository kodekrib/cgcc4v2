                            ...
                            @foreach($joinDepartmentsList as $key => $joinDepartment)
                                <tr data-entry-id="{{ $joinDepartment->id }}">
                                    ...
                                    <td>
                                        ...
                                        @if($joinDepartment->status == 1)
                                            @can('join_department_edit')
                                                <a class="btn btn-xs btn-warning"   data-memberId="{{$joinDepartment->id}}" onclick="onShownDialog('{{$joinDepartment->id}}')">
                                                    Delist
                                                </a>
                                            @endcan
                                        @endif
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('reason') ? 'is-invalid' : '' }}" name="reason" id="reason"></textarea>
