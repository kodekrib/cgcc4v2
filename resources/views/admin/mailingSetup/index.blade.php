...
<input type="hidden" name="_token" id ="_token"value="{{ csrf_token() }}">
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.mailingSetup.title_singular') }}
        </div>
        <div class="card-body">
            <ul class="nav nav-tabs" id="myTab">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#createMailSetup" role="tab">{{ trans('global.create') }} {{ trans('cruds.mailingSetup.title_singular') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#createMailTemplate" role="tab">{{ trans('global.create') }} {{ trans('cruds.mailingSetup.fields.mailing_templete') }}</a>
                </li>

            </ul>

            <div class="tab-content" style="padding-top: 30px;">
                <div class="tab-pane active" id="createMailSetup" role="tabpanel">
                    @include('admin.mailingSetup.create')
                </div>

                <div class="tab-pane " id="createMailTemplate" role="tabpanel">
                    @include('admin.mailingSetup.mailing_template')
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal -->
<div class="modal fade" id="parameterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" >Add User Defined Parameter</h5>
      ...
      <div class="form-group">
                <label for="reason">Parameter</label>
                <input class="form-control" id="parameterUserInput" value=""/>
            </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" onclick="addParater()">Add</button>
      </div>
    </div>
  </div>
</div>
