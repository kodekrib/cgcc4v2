...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.inspectorateGroup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.inspectorate-groups.store") }}" enctype="multipart/form-data">
            @csrf
