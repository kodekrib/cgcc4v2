    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expected_amount') ? 'is-invalid' : '' }}" type="number" name="expected_amount" id="expected_amount" value="{{ old('expected_amount', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_days') ? 'is-invalid' : '' }}" type="number" name="no_of_days" id="no_of_days" value="{{ old('no_of_days', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accredited') ? 'is-invalid' : '' }}" type="number" name="accredited" id="accredited" value="{{ old('accredited', '') }}" step="1">
