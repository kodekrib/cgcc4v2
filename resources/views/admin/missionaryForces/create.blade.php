...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.missionaryForce.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.missionary-forces.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <div class="form-check {{ $errors->has('missionary_force') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="missionary_force" value="0">
                    <input class="form-check-input" type="checkbox" name="missionary_force" id="missionary_force" value="1" {{ old('missionary_force', 0) == 1 ? 'checked' : '' }}>
