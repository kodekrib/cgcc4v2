    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.meetings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('meeting_type') ? 'is-invalid' : '' }}"
                    name="meeting_type_id" id="meeting_type_id">
                    @foreach($meeting_types as $id => $entry)
                    <option value="{{ $id }}" {{ old('meeting_type_id') == $id ? 'selected' : '' }}>{{ $entry }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('re_occurence') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="re_occurence" value="0">
                    <input class="form-check-input" type="checkbox" name="re_occurence" id="re_occurence" value="1"
                        {{ old('re_occurence', 0) === 1 ? 'checked' : '' }} onchange="reoccurence()">
            ...
            <input type="hidden" name="re_occurence_json" id="re_occurence_json" value="">
            <div class="shadow p-3 mb-5  rounded" style="background-color: #f2f2f0;" id="container_re_occur"
                style="display: none;">
                <div class="row">
                    <div class="form-group">
                        <div class="form-check {{ $errors->has('re_occurence') ? 'is-invalid' : '' }}">

                            <input class="form-check-input" type="radio" name="optionType" id="optionType2"
                                value="specific" checked onchange="onChangeoptionType('optionType2')">
                            <label class="form-check-label" for="optionType2">Specific Date in a Month</label>
                        </div>
                        <div class="form-check {{ $errors->has('re_occurence') ? 'is-invalid' : '' }}">

                            <input class="form-check-input" type="radio" name="optionType" id="optionType1"
                                value="frequency" onchange="onChangeoptionType('optionType1')">
                        ...
                        <div class="form-check {{ $errors->has('re_occurence') ? 'is-invalid' : '' }}">
                            ...
                            <input class="form-check-input" type="radio" name="optionType" id="optionType3"
                                value="interval" onchange="onChangeoptionType('optionType3')">
                ...
                <div class="row">
                    <div class="col-2 form-group">
                        ...
                        <input class="form-control  {{ $errors->has('year') ? 'is-invalid' : '' }}" type="text"
                            name="year" id="year" value="{{ now()->year }}" disabled>
                    </div>
                    ...
                    <div class="col-3 form-group" id="container_specific_date">
                        ...
                        <select class="form-control " name="specific_date" id="specific_date"
                            onchange="DateListSpecificCalculation()">
                        </select>
                    </div>
                    <div class="col-3 form-group" id="container_dayinaWeek">
                        <label class="required" for="interval">Day in a Week</label>
                        <select class="form-control select2" name="dayinaWeek" id="dayinaWeek"
                            onchange="DateListfrequecyCalculation()" multiple>
                    ...
                    <div class="col-2 form-group">
                        ...
                        <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}"
                            type="text" name="start_time" id="start_time2" value="{{ old('start_time') }}">
                    </div>
                    <div class="col-2 form-group" id="container_interval">
                        <label class="required" for="interval">Interval in days</label>
                        <input class="form-control {{ $errors->has('interval') ? 'is-invalid' : '' }}" type="number"
                            name="interval" id="interval" value="{{ old('interval') }}"
                            onchange="DateListIntevalCalculation()">
                    </div>
                    ...
                    <div class="col-2 form-group" id="container_end_date">
                        <div>
                            ...
                            <a class="btn btn-xs btn-success" style="color: white; float:right;" id="btnViewDate"
                                onclick="onShowDateList()">
                                View Date List
                            </a>
                        </div>

                        <input class="form-control  {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text"
                            name="end_date" id="end_date" value="" disabled>
                    </div>
                </div>
            </div>
            <input class="form-control {{ $errors->has('date_of_meeting') ? 'is-invalid' : '' }}" type="text"
                name="date_of_meeting" id="date_of_meeting" hidden value="{{ old('date_of_meeting') }}">
            <div id="once">

                <div class="form-group">
                    <label for="date_static">{{ trans('cruds.meeting.fields.date_of_meeting') }}</label>
                    <input class="form-control {{ $errors->has('date_static') ? 'is-invalid' : '' }}" type="text"
                        name="date_static" id="date_static" value="{{ old('date_static') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}"
                        type="text" name="start_time" id="start_time" value="{{ old('time_duration', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time_duration') ? 'is-invalid' : '' }}" type="text"
                    name="time_duration" id="time_duration" value="{{ old('time_duration', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meeting_title') ? 'is-invalid' : '' }}" type="text"
                    name="meeting_title" id="meeting_title" value="{{ old('meeting_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('venue') ? 'is-invalid' : '' }}" name="venue_id"
                    id="venue_id" required>
            ...
            <div class="form-group">
                <input name="attendees_id_list" id="attendees_id_list" hidden />
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select
                                        class="form-control  {{ $errors->has('selected_groups') ? 'is-invalid' : '' }}"
                                        name="selected_groups" id="selected_groups" onchange="onSelectGroup()">
                                        <option value disabled
                                            {{ old('selected_groups', null) === null ? 'selected' : '' }}>
                                            {{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Meeting::GROUP as $id => $entry)
                                        <option value="{{ $id }}" {{ old('selected_groups') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group" id="container_department_id">
                                    ...
                                    <select
                                        ...
                                        name="department_id" id="department_id" onchange="onSelectDept()">
                                ...
                                <div class="form-group" id="container_affinity_group">
                                    ...
                                    <select
                                        class="form-control  {{ $errors->has('affinity_group') ? 'is-invalid' : '' }}"
                                        name="affinity_group" id="affinity_group" onchange="onSelectAffinity_group()">
                                        <option value disabled
                                            {{ old('affinity_group', null) === null ? 'selected' : '' }}>
                                            {{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Meeting::AFFINITY_GROUP as $id => $entry)
                                        <option value="{{ $id }}" {{ old('affinity_group') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                        @endforeach
                                    </select>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('meeting_minutes') ? 'is-invalid' : '' }}"
                    id="meeting_minutes-dropzone">
                </div>
...
<!-- Modal -->
<div class="modal fade" id="addMoreModal" tabindex="-1" role="dialog" aria-labelledby="addMoreModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive" style="width: 100% !important">
                    <table class="table table-bordered table-striped table-hover datatable tableCursor" id="memberListTable"
...
<div class="modal fade" id="dateListmodal" tabindex="-1" role="dialog" aria-labelledby="dateListModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
$(document).ready(() => {
    ...
    onChangeoptionType('optionType2');
    reoccurence();
            ...
            },
            {
                ...
                action: function(e, dt, node, config) {
                    ...
                    $('#addMoreModal tbody').on('dblclick', 'tr', function() {
                        ...
                        if (chk !== undefined) {
                            ErrorNotification(
                                `Member ${chk.member_name} already exit in the list`
                            );
                            return;
                        }
    ...
    document.getElementById('container_department_id').style.display = 'none';
    document.getElementById('container_affinity_group').style.display = 'none';
    document.getElementById('btnViewDate').style.display = 'none';
    $('#department_id').val(null);
    $('#affinity_group').val(null);
});
