        ...
        <form method="POST" action="{{ route("admin.meetings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('re_occurence') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="re_occurence" id="re_occurence" value="1" {{ old('re_occurence', 0) === 1 ? 'checked' : '' }} onchange="reoccurence()">
            ...
            <div class="shadow p-3 mb-5  rounded" style="background-color: #f2f2f0;" id="container_re_occur" style="display: none;" >
                    ...
                    <div class ="row">
                        ...
                        <div class="col-3 form-group" id="container_frequency">
                            ...
                            <select class="form-control  select2" name="frequency" id="frequency" onchange="DateListfrequecyCalculation()" multiple>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time_duration') ? 'is-invalid' : '' }}" type="text" name="time_duration" id="time_duration" value="{{ old('time_duration', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meeting_title') ? 'is-invalid' : '' }}" type="text" name="meeting_title" id="meeting_title" value="{{ old('meeting_title', '') }}" required>
                            ...
                            <div class="col-4" >
                                <div class="form-group">
                                    ...
                                    <select class="form-control  {{ $errors->has('selected_groups') ? 'is-invalid' : '' }}" name="selected_groups" id="selected_groups" onchange="onSelectGroup()">
                                        <option value disabled {{ old('selected_groups', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Meeting::GROUP as $id => $entry)
                                            <option value="{{ $id }}" {{ old('selected_groups') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
