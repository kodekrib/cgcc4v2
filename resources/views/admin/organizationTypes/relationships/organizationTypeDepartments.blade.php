...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-organizationTypeDepartments">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($departments as $key => $department)
                        <tr data-entry-id="{{ $department->id }}">
                            ...
                            <td>
                                {{ $department->hod->firstname ?? '' }}
                            </td>
                            <td>
                                {{ $department->hod->mobile ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-organizationTypeDepartments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
