...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.atsMembershipRecord.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ats-membership-records.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="ats_membership_no">{{ trans('cruds.atsMembershipRecord.fields.ats_membership_no') }}</label>
                <input class="form-control {{ $errors->has('ats_membership_no') ? 'is-invalid' : '' }}" type="text" name="ats_membership_no" id="ats_membership_no" value="{{ old('ats_membership_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('classes') ? 'is-invalid' : '' }}" type="text" name="classes" id="classes" value="{{ old('classes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batch') ? 'is-invalid' : '' }}" type="text" name="batch" id="batch" value="{{ old('batch', '') }}">
                @if($errors->has('batch'))
                    <div class="invalid-feedback">
                        {{ $errors->first('batch') }}
                    </div>
